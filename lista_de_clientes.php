...
<body>
    <a href="cadastrar_clientes.php" class="link-dark mx-2 text-decoration-none m-2"> Voltar</a>
    <br>
    <div class="container bg-success border-4 border text-white p-4 rounded border-secondary rounded-4 
